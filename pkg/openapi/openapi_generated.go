...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/kubernetes-incubator/service-catalog/pkg/apis/servicecatalog/v1beta1.ClusterServicePlan": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "ClusterServicePlan represents a tier of a ClusterServiceClass.",
					Properties: map[string]spec.Schema{
						"kind": {
							SchemaProps: spec.SchemaProps{
								Description: "Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds",
						...
						"spec": {
							SchemaProps: spec.SchemaProps{
								Description: "Spec defines the behavior of the ClusterServicePlan.",
								Ref:         ref("github.com/kubernetes-incubator/service-catalog/pkg/apis/servicecatalog/v1beta1.ClusterServicePlanSpec"),
							},
						},
						"status": {
							SchemaProps: spec.SchemaProps{
								Description: "Status represents the current status of the ClusterServicePlan.",
				...
				SchemaProps: spec.SchemaProps{
					...
					Properties: map[string]spec.Schema{
						...
						"clusterServiceClassRef": {
							SchemaProps: spec.SchemaProps{
								Description: "ClusterServiceClassRef is a reference to the ClusterServiceClass that owns this plan.",
		...
		"github.com/kubernetes-incubator/service-catalog/pkg/apis/servicecatalog/v1beta1.CommonServicePlanStatus": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "CommonServicePlanStatus represents status information about a service plan types.",
					Properties: map[string]spec.Schema{
						"removedFromBrokerCatalog": {
							SchemaProps: spec.SchemaProps{
								Description: "RemovedFromBrokerCatalog indicates that the broker removed the plan from its catalog.",
			...
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					...
					Properties: map[string]spec.Schema{
						...
						"spec": {
							SchemaProps: spec.SchemaProps{
								Description: "Spec defines the behavior of the ServicePlan.",
								Ref:         ref("github.com/kubernetes-incubator/service-catalog/pkg/apis/servicecatalog/v1beta1.ServicePlanSpec"),
							},
						},
						"status": {
							SchemaProps: spec.SchemaProps{
								Description: "Status represents the current status of the ServicePlan.",
			...
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					...
					Properties: map[string]spec.Schema{
						...
						"serviceClassRef": {
							SchemaProps: spec.SchemaProps{
								Description: "ServiceClassRef is a reference to the ServiceClass that owns this plan.",
								Ref:         ref("github.com/kubernetes-incubator/service-catalog/pkg/apis/servicecatalog/v1beta1.ClusterObjectReference"),
							},
						},
					},
